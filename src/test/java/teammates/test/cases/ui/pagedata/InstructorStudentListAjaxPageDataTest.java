...
import teammates.ui.template.instructor.studentlist.AjaxSectionData;
import teammates.ui.template.instructor.studentlist.AjaxStudentData;
import teammates.ui.template.instructor.studentlist.AjaxTeamData;
...
public class InstructorStudentListAjaxPageDataTest {
    ...
    public void allTests() {
        ...
        for (AjaxSectionData section : islapd.getSections()) {
            testSectionContent(section);
        }
    }

    private void testSectionContent(AjaxSectionData section) {
        ...
        for (AjaxTeamData team : section.getTeams()) {
            testTeamContent(team);
        }
    }

    private void testTeamContent(AjaxTeamData team) {
        assertEquals(Sanitizer.sanitizeForHtml(sampleTeam.name), team.getTeamName());
        for (AjaxStudentData student : team.getStudents()) {
            testStudentContent(student);
        }
    }

    private void testStudentContent(AjaxStudentData student) {
