...
public class InstructorStudentListAjaxPageData extends PageData {
    ...
    private List<AjaxSectionData> sections;
    ...
    public InstructorStudentListAjaxPageData(AccountAttributes account, String courseId, int courseIndex,
        ...
        List<AjaxSectionData> sectionsDetails =
                                        new ArrayList<AjaxSectionData>();
        for (SectionDetailsBundle section: sections) {
            ...
            sectionsDetails.add(new AjaxSectionData(section, isAllowedToViewStudentInSection,
    ...
    public List<AjaxSectionData> getSections() {
        return sections;
    }
